<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Notice.aspx.cs" Inherits="CEB.Notice" %>
    ...
    <div class='row'>
        <div class='panel panel-inverse' data-sortable-id='ui-widget-5' data-scrollbar='true'>
            ...
            <div class='panel-body'>
                ...
                <asp:SqlDataSource ID="SqlDataSourceInbox" runat="server" ConnectionString="<%$ ConnectionStrings:CEBConnectionString %>" SelectCommand="SELECT [description], [sentTime] FROM [Notification] ORDER BY [sentTime] DESC"></asp:SqlDataSource>
            </div>
        </div>
    </div>
</asp:Content>
